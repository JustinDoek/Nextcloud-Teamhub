...
class Version000300901Date20260421000000 extends SimpleMigrationStep {
    ...
    public function changeSchema(IOutput $output, Closure $schemaClosure, array $options): ?ISchemaWrapper {
        ...
        $renames = [
            'teamhub_integ_registry'    => ['old' => $prefix . 'teamhub_integ_registry_pkey',    'new' => 'th_integ_reg_pk'],
            'teamhub_team_integrations' => ['old' => $prefix . 'teamhub_team_integrations_pkey',  'new' => 'th_team_integ_pk'],
            'teamhub_widget_layouts'    => ['old' => $prefix . 'teamhub_widget_layouts_pkey',     'new' => 'th_widget_lyt_pk'],
        ];
